...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Prueba', [
      ...
      { nombre: 'Prueba 2', nota: 1.5, cursoId: 2, alumnoId: 1, createdAt: new Date(), updatedAt: new Date()},      
      { nombre: 'Prueba 2', nota: 4.8, cursoId: 2, alumnoId: 2, createdAt: new Date(), updatedAt: new Date()}, 
      { nombre: 'Prueba 2', nota: 3.0, cursoId: 2, alumnoId: 3, createdAt: new Date(), updatedAt: new Date()},
      { nombre: 'Prueba 3', nota: 1.5, cursoId: 2, alumnoId: 1, createdAt: new Date(), updatedAt: new Date()},      
      { nombre: 'Prueba 3', nota: 1.8, cursoId: 2, alumnoId: 2, createdAt: new Date(), updatedAt: new Date()}, 
      { nombre: 'Prueba 3', nota: 1.0, cursoId: 2, alumnoId: 3, createdAt: new Date(), updatedAt: new Date()},
      ...
      { nombre: 'Prueba 2', nota: 1.5, cursoId: 3, alumnoId: 1, createdAt: new Date(), updatedAt: new Date()},      
      { nombre: 'Prueba 2', nota: 1.8, cursoId: 3, alumnoId: 2, createdAt: new Date(), updatedAt: new Date()}, 
      { nombre: 'Prueba 2', nota: 1.0, cursoId: 3, alumnoId: 3, createdAt: new Date(), updatedAt: new Date()},
      { nombre: 'Prueba 3', nota: 1.5, cursoId: 3, alumnoId: 1, createdAt: new Date(), updatedAt: new Date()},      
      { nombre: 'Prueba 3', nota: 1.8, cursoId: 3, alumnoId: 2, createdAt: new Date(), updatedAt: new Date()}, 
      { nombre: 'Prueba 3', nota: 1.0, cursoId: 3, alumnoId: 3, createdAt: new Date(), updatedAt: new Date()}
    ], {});
  },
